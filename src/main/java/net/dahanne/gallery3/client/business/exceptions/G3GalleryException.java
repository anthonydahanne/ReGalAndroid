...
public class G3GalleryException extends Exception {

	public G3GalleryException(Throwable arg0) {
		super(arg0);
	}
	public G3GalleryException() {
		super();
	}
	private static final long serialVersionUID = -2438128686943266378L;
	public G3GalleryException(String string) {
		super(string);
	}
